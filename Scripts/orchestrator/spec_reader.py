...
from project_config import get_specs_dir
...
def _resolve_spec_path(spec_path: str) -> Path:
    ...
    specs_candidate = get_specs_dir() / candidate
    if specs_candidate.is_file():
        return specs_candidate
